...
- [x] The app is generated. (**+5**)
- [x] Added base project structure for components and models.(**+10**)
- [x] ESLint is configured for TypeScript, the `no-explicit-any` rule is enabled. (**+10**)
- [x] TypeScript is configured, the `noImplicitAny: true` and `strict: true`. (**+10**)
- [x] All the necessary components were created. (**+15**)
- [x] All the necessary models were created. Search result list and search item components contain declarations of necessary fields. (**+20**)
